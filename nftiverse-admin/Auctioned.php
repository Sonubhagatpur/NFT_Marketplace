                    ...
                    <div class="row mt-4">
                      <div class="col-md-12">
                         <div class="heading-sec">
                             <h4> <img src="img/nfts.png" width="28"> Auction based listed NFTs</h4>
                         </div> 
                      </div>  
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                $uerry = mysqli_query($link, "SELECT * FROM `NFT_info` WHERE `Mintstatus`=1 AND `NFT_type`=1 ORDER BY id DESC");
