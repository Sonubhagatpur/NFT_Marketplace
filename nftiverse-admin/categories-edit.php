 ...
 $category = mysqli_query($link, "SELECT * FROM `nft_category` WHERE `id`='$id'");
                    ...
                    <div class="row mt-4">
                      <div class="col-md-12">
                         <div class="heading-sec">
                             <h4> <i class="fa-solid fa-layer-group"></i> Edit Category </h4>
                         </div> 
                      </div>  
                    </div>
                           ...
                           <div class="card p-3">
                             <form method="post" enctype='multipart/form-data'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"> 
                                        <input class="form-control" type="file" name="img" id="profile_img" accept="image/*"> <br>
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="cat_name" value="<?php echo $categories['category_name']; ?>" class="form-control" type="text" id="cat_name" autocomplete="off" required=""> 
                                    </div> 
                                ...
                                <!--    <div class="col-sm-6"> -->
                                <!--        <textarea name="description" cols="30" rows="3" id="description" class="form-control" style="width:100%"></textarea>-->
                                <!--    </div>-->
                                ...
                                <div class="row mt-3" align="center">
                                    <div class="col-sm-8 col-sm-offset-3">
                                        <!--<button onclick="history.back()" class="btn btn-primary  w-md m-b-5" style="width:auto;">Cancel</button>-->
                                        <button name="edit" type="submit" class="btn btn-success  w-md m-b-5" style="width:auto;">Update</button>
                                    </div>
                                </div>
                            </form>                    
