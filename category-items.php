...
$nft_category = $_GET['nft_category'];
			...
			<section aria-label="section" class="pt-0">
                <div class="container">
                    <div class="row wow fadeIn">
                        ...
                        <?php $uerry = mysqli_query($link, "SELECT * FROM `NFT_info` WHERE `Mintstatus`=1 AND `approved`=1 AND `block`=0 AND `NFT_category`='$nft_category' ORDER BY id DESC");
